...
jumpSound.src = "./rtanrun_asset/sounds/jump.mp3";
const bgmSound = new Audio(); // 배경 음악
bgmSound.src = "./rtanrun_asset/sounds/bgm.mp3";
const scoreSound = new Audio(); // 점수 획득 소리
scoreSound.src = "./rtanrun_asset/sounds/score.mp3";
const defeatSound = new Audio(); // 게임 오버 소리
defeatSound.src = "./rtanrun_asset/sounds/defeat2.mp3";

/** 이미지 객체 생성 및 설정 */
// (1) 배경
const bgImage = new Image();
bgImage.src = "./rtanrun_asset/images/background2.jpg";
// (2) 게임 시작
const startImage = new Image();
startImage.src = "./rtanrun_asset/images/gamestart.png";
// (3) 게임 오버
const gameoverImage = new Image();
gameoverImage.src = "./rtanrun_asset/images/gameover.png";
// (4) 게임 재시작
const restartImage = new Image();
restartImage.src = "./rtanrun_asset/images/restart.png";
// (5) 달리는 르탄이 A
const rtanAImage = new Image();
rtanAImage.src = "./rtanrun_asset/images/rtan_running_a.png";
// (6) 달리는 르탄이 B
const rtanBImage = new Image();
rtanBImage.src = "./rtanrun_asset/images/rtan_running_b.png";
// (7) 게임 오버 르탄이
const rtanCrashImage = new Image();
rtanCrashImage.src = "./rtanrun_asset/images/rtan_crash.png";
// (8) 장애물
